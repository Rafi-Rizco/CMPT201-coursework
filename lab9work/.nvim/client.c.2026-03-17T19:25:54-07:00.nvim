...
4. How does the client program end? How can you tell that in the code?
  it ends when the client presses enter with no other inputs, or
there is an error reading the input stream, or reading from the input stream
returns 0 for EOF (end of file), or the client sends more than the buffer size.
